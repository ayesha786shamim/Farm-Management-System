        ...
        <div className="mt-0 mb-0 px-5 h-screen">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-y-4 gap-x-6 mb-4 text-[14px] font-Montserrat">
                ...
                <div className="flex gap-2">
                    ...
                    <span className="text-Golden font-medium font-Poppins">
                        {orderDetails.status}
                    </span>
            ...
            {/* product information */}
            <div className="mb-4">
                <h2 className="text-Golden text-[18px] font-Montserrat font-bold">
                    Product Information
                </h2>

                <p className="text-[14px] font-Montserrat font-normal text-Gray mt-1">
                    Total Products :
                    <span className="text-[14px] font-Montserrat font-semibold text-Gray">
                    ...
                    <div
                        ...
                        <div className='w-[206px] h-[180px] flex justify-center items-center bg-white rounded shadow-md'>
                            <img
                                src={product.image}
                                alt={product.name}
                                className="w-[198px] h-[153px] object-contain"
                            />
                        </div>
                        ...
                        <div className='mt-7 space-y-2'>
                            ...
                            <h3 className="text-Black text-[24px] font-Montserrat font-semibold">
                                {product.name}
                            </h3>

                            <p className="text-Gray text-[16px] font-Poppins font-thin">

                                Category :{" "}
                                <span className="text-Golden text-[16px] font-Poppins font-normal">
                                    {product.category}
                                </span>
                            ...
                            <p className="text-Gray text-[16px] font-Poppins font-normal">
                                ...
                                Quantity :{" "}
                                <span className="text-Black text-[16px] font-Poppins font-normal">
                                    {product.quantity}
                                </span>
                            </p>
